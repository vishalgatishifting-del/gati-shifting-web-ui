...
const CityPage: React.FC<PageProps> = ({
  ...
  return (
    <>
      ...
      {(city != "Agra" && city != "Ankleshwar" && city != "Bhiwandi" && city != "Calicut" && city != "Cuttack" && city != "Ahmedabad" && city != "Amrawati" && city != "Imphal" && city != "Bhadrak" && city != "Bargarh" && city != "Jeypore" && city != "Kendrapara" && city != "Rayagada" && city != "Whitefield" && city != "Electronic City" && city != "Koramangala" && city != "Indiranagar" && city != "Marathahalli" && city != "Yelahanka" && city != "Jayanagar" && city != "Rajajinagar" && city != "HSR Layout" && city != "BTM Layout" && city != "Solapur" && city != "Sangli" && city != "Jalgaon" && city != "Akola" && city != "Latur" && city != "gandhidham" && city != "guwahati" && city != "hyderabad" && city != "jamshedpur" && city != "kolhapur" && city != "lucknow" && city != "Bhopal" && city != "Chandigarh" && city != "Dehradun" && city != "Gandhidham" && city != "Guwahati" && city != "Hyderabad" && city != "Jamshedpur" && city != "Kolhapur" && city != "Lucknow" && city != "Ahmedabad" && city != "Aurangabad" && city != "Bhopal" && city != "Chandigarh" && city != "Dehradun" && city != "Ghaziabad" && city != "Gwalior" && city != "Indore" && city != "Jamnagar" && city != "Ludhiana" && city != "Kolkata" && city != "Allahabad" && city != "Alwar" && city != "Ambala" && city != "Vadodara" && city != "Dhule" && city != "Chandrapur" && city != "Parbhani" && city != "Nanded" && city != "Wardha" && city != "Satara" && city != "Ratnagiri" && city != "Palghar" && city != "Basavanagudi" && city != "Mysuru" && city != "Dharwad" && city != "Belagavi" && city != "Bellary" && city != "Kalaburagi" && city != "Gulbarga" && city != "Davanagere" && city != "Tumakuru" && city != "Shivamogga" && city != "Raichur" && city != "Kochi (Cochin)" && city != "Delhi" && city != "Dwarka" && city != "Faridabad" && city != "Goa" && city != "Greater Noida" && city != "Gurgaon" && city != "Hubli" && city != "Jammu" && city != "Kanpur" && city != "Vijayapura" && city != "Bidar" && city != "Hassan" && city != "Chitradurga" && city != "Kolar" && city != "Udupi" && city != "Karwar" && city != "Bagalkot" && city != "Varanasi" && city != "Thoubal" && city != "Churachandpur" && city != "Bishnupur" && city != "Ukhrul" && city != "Senapati" && city != "Kakching" && city != "Tamenglong" && city != "Jiribam" && city != "Moreh" && city != "Shimla" && city != "Manali" && city != "Kullu" && city != "Mandi" && city != "Solan" && city != "Dharamshala" && city != "Kangra" && city != "Hamirpur" && city != "Chamba" && city != "Kinnaur" && city != "Keylong" && city != "Srinagar" && city != "Anantnag" && city != "Baramulla" && city != "Udhampur" && city != "Kathua" && city != "Sopore" && city != "Kupwara" && city != "Pulwama" && city != "Rajouri" && city != "Poonch" && city != "Bandipora" && city != "Ganderbal" && city != "Kulgam" && city != "Doda" && city != "Kishtwar" && city != "Samba" && city != "Shopian" && city != "Champhai" && city != "Serchhip" && city != "Kolasib" && city != "Mamit" && city != "Lawngtlai" && city != "Saiha" && city != "Khawzawl" && city != "Saitual" && city != "Hnahthial" && city != "Gangtok" && city != "Namchi" && city != "Gyalshing" && city != "Mangan" && city != "Singtam" && city != "Rangpo" && city != "Jorethang" && city != "Soreng" && city != "Chungthang" && city != "Pakyong" && city != "Ravangla" && city != "Lakhisarai" && city != "Buxar" && city != "Vijayawada" && city != "Guntur" && city != "Nellore" && city != "Tirupati" && city != "Kurnool" && city != "Kadapa" && city != "Rajahmundry" && city != "Jaisalmer" && city != "Eluru" && city != "Ongole" && city != "Srikakulam" && city != "Vizianagaram" && city != "Chittoor" && city != "Proddatur" && city != "Hindupur" && city != "Tenali" && city != "Nandyal" && city != "Adoni" && city != "Vasco da Gama" && city != "Tiruchirappalli (Trichy)" && city != "Madurai" && city != "Salem" && city != "Tirunelveli" && city != "Erode" && city != "Vellore" && city != "Thanjavur" && city != "Thoothukudi (Tuticorin)" && city != "Dindigul" && city != "Nepal" && city != "Kollam" && city != "Alappuzha" && city != "Idukki" && city != "Kozhikode" && city != "Wayanad" && city != "Kannur" && city != "Kasaragod" && city != "Pathanamthitta" && city != "Warangal" && city != "Nizamabad" && city != "Khammam" && city != "Karimnagar" && city != "Mahbubnagar" && city != "Adilabad" && city != "Nagarkurnool" && city != "Medak" && city != "Vikarabad" && city != "Suryapet" && city != "Wanaparthy" && city != "Howrah" && city != "Nainital" && city != "Almora" && city != "Mussoorie" && city != "Bareilly" && city != "Aligarh" && city != "Moradabad" && city != "Saharanpur" && city != "Jhansi" && city != "Mathura" && city != "Firozabad" && city != "Mysore" && city != "Bangalore" && city != "Jabalpur" && city != "Ujjain" && city != "Sagar" && city != "Satna" && city != "Kohima" && city != "Amritsar" && city != "Jalandhar" && city != "Patiala" && city != "Bathinda" && city != "Bokaro Steel City" && city != "Hazaribagh" && city != "Dhanbad" && city != "Karnal" && city != "Yamunanagar" && city != "Rohtak" && city != "Panipat" && city != "Hisar" && city != "Nadiad" && city != "Bhavnagar" && city != "Jodhpur" && city != "Kota" && city != "Ajmer" && city != "Udaipur" && city != "Agartala" && city != "Port Blair" && city != "Katni" && city != "Rewa" && city != "Korba" && city != "Raigarh" && city != "Chhattisgarh" && city != "Manipal" && city != "Ranchi")   ? (
